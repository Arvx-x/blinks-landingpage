...
const GooeyNav: React.FC<GooeyNavProps> = ({
  ...
  const handleKeyDown = (e: React.KeyboardEvent<HTMLAnchorElement>, index: number, href?: string) => {
    if (e.key === 'Enter' || e.key === ' ') {
      ...
      if (liEl) {
        // Trigger animation/effect positioning
        const fakeEvent = { currentTarget: liEl } as unknown as React.MouseEvent<HTMLAnchorElement>;
        handleClick(fakeEvent, index, href);
      }
    }
  };
  useEffect(() => {
